...
export default function ChatInterface({ userName = "Student" }: ChatInterfaceProps) {
  ...
  return (
    <div className="flex h-screen">
      {sidebarOpen && (
        <div className="w-80 border-r border-sidebar-border bg-sidebar p-4 flex flex-col">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-semibold font-['Poppins']">Sessions</h2>
      ...
      <div className="flex-1 flex flex-col">
        ...
        {currentMoods.length > 0 && <MoodTimeline moods={currentMoods} />}
